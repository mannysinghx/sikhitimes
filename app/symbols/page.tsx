      ...
      <section className="mb-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
          {emblems.map(symbol => {
            ...
            return (
              <article key={symbol.id} className={`rounded-2xl border p-6 text-center ${style.bg}`}>
                {symbol.symbol && (
      ...
      <section className="mb-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
          {articles.map((symbol, i) => {
            ...
            const icons = ["💈", "⭕", "🪮", "👕", "⚔️"];
            return (
              <article key={symbol.id} className="bg-white rounded-xl border border-blue-100 shadow-sm p-4 text-center">
      ...
      <section className="mb-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {concepts.map(symbol => {
            ...
            return (
              <article key={symbol.id} className={`rounded-xl border p-5 ${style.bg}`}>
